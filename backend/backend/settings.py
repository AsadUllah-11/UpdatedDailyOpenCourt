...
CORS_ALLOWED_ORIGINS = os.environ.get(
    ...
    'http://localhost:3000'
).split(',') if os.environ.get('CORS_ALLOWED_ORIGINS') else ['http://localhost:3000']
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=int(os.environ.get('JWT_ACCESS_TOKEN_LIFETIME_HOURS', 5))),
